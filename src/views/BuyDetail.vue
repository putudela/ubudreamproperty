...
<style>
    ...
    .content-detail .card .card-footer{
		border-top: 1px solid var(--lightGrey);
		background: white;
		padding: 0;
		margin: 0;
	}
	.content-detail .card .card-footer .row{
		display: flex;
		align-items: center;
	...
	/* .content-detail .card .card-footer .list{
		width: 33.3%;
	} */
	.content-detail .card .card-footer .list.vline{
		border-right: 1px solid var(--lightGrey);
		padding: 15px 10px;
	}
	.content-detail .card .card-footer .list-info{
		display: flex;
		align-items: center;
		justify-content: center;
	}
	.content-detail .card .card-footer .list-info svg{
		margin-right: 5px;
	}
	.content-detail .card .card-footer .list-info span{
		font-size: 9pt;
		font-weight: 600;
		color: var(--primaryColor);
	}
    .content-detail .card .card-footer .price{
        text-align: right;
        color: var(--primaryColor);
        display: flex;
    ...
    .content-detail .content_info .description .desc_title h6{
        font-weight: 700;
    }
    .content-detail .description p.desc{
        color: var(--darkGrey);
        text-align: justify;
    ...
    .content-detail .content_info .contact-btn{
        margin-top: 50px;
    }
    .content-detail .content_info .contact-btn .btn{
        display: block;
    }
    .content-detail .content_info .contact-btn .btn__primary{
    ...
    .content-detail .content_info .contact-btn .btn__primary:hover{
        background: var(--secondaryColor);
    }
    .content-detail .content_info .contact-btn .btn__primary svg{
        margin-right: 5px;
    }
    .content-detail .content_info .contact-btn .btn__secondary{
        background: white;
        color: var(--primaryColor);
    ...
    .content-detail .content_info .contact-btn .btn__secondary:hover{
